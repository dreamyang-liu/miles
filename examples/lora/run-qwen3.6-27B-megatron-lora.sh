...
# Qwen3.6-27B LoRA training script using Megatron-Bridge backend with GRPO.
# Requires 8x H100/A100 80GB GPUs. TP=4 (must divide num_query_groups=4), DP=2.
...
source "${REPO_ROOT}/scripts/models/qwen3.6-27B.sh"

HF_CHECKPOINT=${HF_CHECKPOINT:-"/root/models/Qwen3.6-27B"}
DATASET_PATH=${DATASET_PATH:-"/root/miles/training_prompts.jsonl"}
SAVE_PATH=${SAVE_PATH:-"/root/checkpoints/qwen3.6-27B-lora"}
