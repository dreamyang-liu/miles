...
# Qwen3.5-27B LoRA training script using Megatron-Bridge backend with GRPO.
...
HF_CHECKPOINT=${HF_CHECKPOINT:-"/root/models/Qwen3.5-27B"}
DATASET_PATH=${DATASET_PATH:-"/root/miles/training_prompts.jsonl"}
SAVE_PATH=${SAVE_PATH:-"/root/checkpoints/qwen3.5-27B-lora"}
